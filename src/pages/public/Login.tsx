...
export const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-transparent">
            ...
            <div className="max-w-md w-full space-y-8 p-8 bg-primary shadow-primary hover:shadow-lg transition-shadow duration-300 ease-in-out">
                    ...
                    <div className="flex flex-col space-y-6 mb-14">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                required
                                className="relative block w-full px-3 py-2 bg-white placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                                placeholder="Usuario"
                                value={userName}
